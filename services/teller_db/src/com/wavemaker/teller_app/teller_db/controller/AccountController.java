...
import com.wavemaker.teller_app.teller_db.service.AccountService;
...
public class AccountController {
    ...
    @ApiOperation(value = "Returns the matching Account with given unique key values.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Account getByAccountNumber(@PathVariable("accountNumber") int accountNumber) {
        LOGGER.debug("Getting Account with uniques key AccountNumber");
    ...
    @GetMapping(value="/{id:.+}/depositAccounts")
    @ApiOperation(value = "Gets the depositAccounts instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<DepositAccount> findAssociatedDepositAccounts(@PathVariable("id") Integer id, Pageable pageable) {

        LOGGER.debug("Fetching all associated depositAccounts");
        return accountService.findAssociatedDepositAccounts(id, pageable);
    }

    @GetMapping(value="/{id:.+}/transactionHistories")
    @ApiOperation(value = "Gets the transactionHistories instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<TransactionHistory> findAssociatedTransactionHistories(@PathVariable("id") Integer id, Pageable pageable) {

        LOGGER.debug("Fetching all associated transactionHistories");
        return accountService.findAssociatedTransactionHistories(id, pageable);
    }
