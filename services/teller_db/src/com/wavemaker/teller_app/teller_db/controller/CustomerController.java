...
import com.wavemaker.teller_app.teller_db.service.CustomerService;
...
public class CustomerController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Customer getByCustomerId(@PathVariable("customerId") String customerId) {
        LOGGER.debug("Getting Customer with uniques key CustomerId");
    ...
    public Page<Account> findAssociatedAccounts(@PathVariable("id") Integer id, Pageable pageable) {
        ...
        return customerService.findAssociatedAccounts(id, pageable);
    }
