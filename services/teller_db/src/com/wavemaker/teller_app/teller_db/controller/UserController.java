...
import com.wavemaker.teller_app.teller_db.service.UserService;
...
public class UserController {
    ...
    public User getByUserName(@PathVariable("userName") String userName) {
        LOGGER.debug("Getting User with uniques key UserName");
