 ...
 * @see Account
 */
@Service("teller_db.AccountService")
@Validated
@EntityService(entityClass = Account.class, serviceId = "teller_db")
public class AccountServiceImpl implements AccountService {
    ...
    @Autowired
    @Qualifier("teller_db.AccountDao")
    ...
    public Account getByAccountNumber(int accountNumber) {
        ...
        LOGGER.debug("Finding Account by unique keys: {}", accountNumberMap);
    ...
    public Account partialUpdate(Integer accountId, Map<String, Object>accountPatch) {
        ...
        try {
            ObjectReader accountReader = WMObjectMapper.getInstance().reader().forType(Account.class).withValueToUpdate(account);
            account = accountReader.readValue(WMObjectMapper.getInstance().writeValueAsString(accountPatch));
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service teller_db for table Account to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service teller_db for table Account to {} format", options.getExportType());
    ...
    @Transactional(readOnly = true, value = "teller_dbTransactionManager")
    @Override
    public Page<DepositAccount> findAssociatedDepositAccounts(Integer id, Pageable pageable) {
        LOGGER.debug("Fetching all associated depositAccounts");

        StringBuilder queryBuilder = new StringBuilder();
        queryBuilder.append("account.id = '" + id + "'");

        return depositAccountService.findAll(queryBuilder.toString(), pageable);
    }

    @Transactional(readOnly = true, value = "teller_dbTransactionManager")
    @Override
    public Page<TransactionHistory> findAssociatedTransactionHistories(Integer id, Pageable pageable) {
        LOGGER.debug("Fetching all associated transactionHistories");

        StringBuilder queryBuilder = new StringBuilder();
        queryBuilder.append("account.id = '" + id + "'");

        return transactionHistoryService.findAll(queryBuilder.toString(), pageable);
    }
