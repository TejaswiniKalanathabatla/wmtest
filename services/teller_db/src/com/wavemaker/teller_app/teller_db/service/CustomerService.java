...
public interface CustomerService {
     ...
     */
    Customer getById(Integer customerIdInstance);
     ...
     */
    List<Customer> findByMultipleIds(List<Integer> customerIdInstances, boolean orderedReturn);

    /**
     * Find and return the Customer for given customerId  if exists.
     *
     ...
     * @throws EntityNotFoundException if no Customer is found with given input.
     */
    Customer partialUpdate(Integer customerIdInstance, Map<String, Object> customerPatch);
     ...
     */
    Customer delete(Integer customerIdInstance);
    ...
    /*
     * Returns the associated accounts for given Customer id.
     *
