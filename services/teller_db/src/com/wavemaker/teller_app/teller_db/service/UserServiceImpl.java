 ...
 * @see User
 */
@Service("teller_db.UserService")
@Validated
@EntityService(entityClass = User.class, serviceId = "teller_db")
public class UserServiceImpl implements UserService {
    ...
    public User getByUserName(String userName) {
        ...
        LOGGER.debug("Finding User by unique keys: {}", userNameMap);
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service teller_db for table User to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service teller_db for table User to {} format", options.getExportType());
